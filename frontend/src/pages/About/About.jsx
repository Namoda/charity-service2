  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12">
      <div className="max-w-4xl mx-auto px-6">
        <h1 className="text-4xl font-bold text-center text-gray-800 mb-8 animate-fade-in">About Us</h1>
        <div className="bg-white rounded-lg shadow-lg p-8 animate-slide-up flex flex-col md:flex-row items-center md:items-start">
          ...
          <div className="md:w-1/4 md:ml-6 mt-6 md:mt-0 flex justify-center md:block">
            <img
              src="https://example.com/about-us-small.jpg"
              alt="About Us"
        ...
        <div className="mt-12">
          <img
            src="https://example.com/about-us.jpg"
            alt="About Us"
