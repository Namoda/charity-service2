                        ...
                        <form className="space-y-4" onSubmit={handleFormSubmit}>
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <p className='text-[12px] ml-2 text-red-400'>If the user is an coach, then set skills; otherwise, leave it empty</p>
                                    <input
                                        className="w-full mt-2 rounded-lg border outline-none border-secondary p-3 text-sm"
                                        placeholder="Skills"
                            ...
                            <div className="grid grid-cols-1 gap-4 text-center sm:grid-cols-3">
                                ...
                                <div>
                                    <input
                                        ...
                                        value='volunteer'
                                        type="radio"
                                        defaultChecked={userCredentials?.role === 'volunteer' ? true : false}
                                        tabIndex="-1"
                                        name="option"
                                    />
                                    <label
