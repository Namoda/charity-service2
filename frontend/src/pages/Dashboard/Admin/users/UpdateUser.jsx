                    ...
                    <div className="rounded-lg bg-white p-8 shadow-lg  lg:p-12">
                        <form className="space-y-4" onSubmit={handleFormSubmit}>
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div>
                                    <label className="ml-2" htmlFor="phone">Leadership</label>
                                    <p className='text-[12px] ml-2 text-red-400'>If the user is a volunteer, then set leadership; otherwise, leave it empty</p>
                                    <input
                                        className="w-full mt-2 rounded-lg border outline-none border-secondary p-3 text-sm"
                                        placeholder="Skills"
