            ...
            <form className="space-y-4" onSubmit={handleFormSubmit}>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <p className='text-[12px] ml-2 text-red-400'>If the user is a coach, then set skills; otherwise, leave it empty</p>
                  <input
                    className="w-full mt-2 rounded-lg border outline-none border-secondary p-3 text-sm"
                    placeholder="Skills"
              ...
              <div className="grid grid-cols-1 gap-4 text-center sm:grid-cols-3">
                ...
                <div>
                  <input
                    ...
                    type="radio"
                    value='volunteer'
                    defaultChecked={userCredentials?.role === 'volunteer'}
                    tabIndex="-1"
                    name="role"
                  />
                  <label
              ...
              <div className="mt-4">
                <button
                  type="submit"
                  className={`inline-block w-full rounded-lg bg-secondary px-5 py-3 font-medium text-white sm:w-auto ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                  disabled={loading}
                >
